...
Can get the complete framwort @ https://github.com/vasu31dev/playwright-ts-template?tab=readme-ov-file#run-tests-using-playwright-test-for-vscode-extension